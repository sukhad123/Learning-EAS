...
export interface ISchemaResolverInterface extends Interface {
    getFunction(nameOrSignature: "attest" | "isPayable" | "multiAttest" | "multiRevoke" | "revoke" | "version"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "multiAttest", values: [AttestationStruct[], BigNumberish[]]): string;
    encodeFunctionData(functionFragment: "multiRevoke", values: [AttestationStruct[], BigNumberish[]]): string;
...
export interface ISchemaResolver extends BaseContract {
    ...
    getFunction(nameOrSignature: "isPayable"): TypedContractMethod<[], [boolean], "view">;
...
//# sourceMappingURL=ISchemaResolver.d.ts.map